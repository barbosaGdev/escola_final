			...
			jQuery.ajax({
				...
				success: function(data){
                    ...
                    if(data[0].status == "Pendente")
                        showSucess("Sua matricula ainda esta pendente, aguarde mais um pouco");
                    ...
                    if(data[0].cpf == null || data[0].status == "rejeitado")
                        showError("O candidato não cadastrou o cpf ou teve sua matrícula rejeitada, favor aguardar na fila da escola em que se inscreveu!");
