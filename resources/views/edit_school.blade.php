...
<body>
    ...
    @endif
        ...
        <div class="box box-school">
            <h1 class="h1-simple-1 p-t-20">Editar Escola</h1>
            <input type="text" class="input-special-1" id="input_name" value="{{ $escolas->nome }}">
            <input type="text" class="input-special-1" id="input_endereco" value="{{ $escolas->endereco }}" placeholder="Endereço da escola">
